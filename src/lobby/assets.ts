...
export const CHARACTERS: Record<string, CharacterEntry> = {
  ...
  "visitor-1": { src: "/lobby/visitor-1.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5799, y: 0.9499 }, width: 41.75, headY: -62 },
  "visitor-2": { src: "/lobby/visitor-2.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5693, y: 0.9392 }, width: 45.36, headY: -62 },
  "visitor-3": { src: "/lobby/visitor-3.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5431, y: 0.9492 }, width: 38.5, headY: -65 },
  "visitor-4": { src: "/lobby/visitor-4.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5833, y: 0.9435 }, width: 41.72, headY: -62 },
  "visitor-5": { src: "/lobby/visitor-5.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.566, y: 0.9465 }, width: 40.48, headY: -62 },
  "visitor-6": { src: "/lobby/visitor-6.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5325, y: 0.9348 }, width: 48.5, headY: -62 },
  "visitor-7": { src: "/lobby/visitor-7.webp", poses: ["front", "backWalk1", "walk1", "back"], anchor: { x: 0.5942, y: 0.9352 }, width: 44.42, headY: -62 },
